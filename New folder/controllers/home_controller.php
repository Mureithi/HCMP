...
public function get_dash_board_stats($dash_board_indicator){
	...
	$decommissioned_items['total']=(count($decommissioned_items)==0)?0:$decommissioned_items;
	...
	$facility_data='	<tr>
    	  ...
    	  <tr>
  				<td>% Coverage</td>
           <td>  <div class="badge" >'.round(($facility_data['total_no_of_facilities_using_hcmp']/$facility_data['total_no_of_facilities'])*100,1).'%</div></td>
    		</tr>
    		<tr>
  				<td># of pending orders</td>
           <td>  <div class="badge" >'.$pending_orders.'</div></td>
    		</tr>
    		<tr>
  				<td># of decommissioned items</td>
           <td>  <div class="badge" >'.$decommissioned_items['total'].'</div></td>
    		</tr>
    		';
	 break;
	 case 'district':
