...
<div class='label label-info'>Expired Commodities - Trend <?php echo date("Y"); ?></div>
			<div  style="overflow:auto; height: 30%; width: 100%" id="chart_3"></div>	
...
<div class='label label-info'>Commodities Expiring between <?php echo date('jS F, Y'); ?> and <?php echo date('jS F, Y', strtotime('+6 months')); ?></div>
